    ...
    <section class="navbar navbar-default navbar-static-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <!-- lOGO TEXT HERE -->
                <a href="home.php" class="navbar-brand"><i class="fa fa-c-square"></i>WaytoLyf App</a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="footer-thumb">
                        ...
                        <p>WaytoLyf Limited<br>College Square-745896<br>Kolkata, W.B.</p>
